...
import com.yxe.mvvm.utils.SDCardUtils;
import com.yxe.mvvm.utils.StorageUtil;
import com.yxe.ktarmor.ui.trim.IVideoTrimmerView;
import com.yxe.ktarmor.ui.trim.VideoTrimListener;
import com.yxe.ktarmor.ui.trim.VideoTrimmerAdapter;
import com.yxe.ktarmor.ui.trim.VideoTrimmerUtil;
...
import static com.yxe.ktarmor.ui.trim.VideoTrimmerUtil.MAX_COUNT_RANGE;
import static com.yxe.ktarmor.ui.trim.VideoTrimmerUtil.MAX_SHOOT_DURATION;
import static com.yxe.ktarmor.ui.trim.VideoTrimmerUtil.RECYCLER_VIEW_PADDING;
import static com.yxe.ktarmor.ui.trim.VideoTrimmerUtil.THUMB_WIDTH;
import static com.yxe.ktarmor.ui.trim.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
  ...
  private void onSaveClicked() {
    if (mRightProgressPos - mLeftProgressPos < VideoTrimmerUtil.MIN_SHOOT_DURATION) {
      ...
      VideoTrimmerUtil.trim(mContext,
          mSourceUri.getPath(),
              mContext.getExternalFilesDir(Environment.DIRECTORY_MOVIES).getAbsolutePath(),
